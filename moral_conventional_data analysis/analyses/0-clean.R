...
## Korean Data ====
korea.data <- read.csv(here::here('C:/Users/Bubulubu/Documents/haleh_project_2024/data/raw_data/study1/korea.csv'))
...
iran.data <- read.csv(here::here('C:/Users/Bubulubu/Documents/haleh_project_2024/data/raw_data/study1/iran.csv'))
...
## Canadian Data ====
##canada data
canada.data <- read.csv(here::here("C:/Users/Bubulubu/Documents/haleh_project_2024/data/raw_data/study1/canada.csv"))
...
india.data <- read.csv(here::here("C:/Users/Bubulubu/Documents/haleh_project_2024/data/raw_data/study1/india.csv"))
...
india.roster <- read.csv(here::here("C:/Users/Bubulubu/Documents/haleh_project_2024/data/raw_data/study1/india_mc_roster.csv"))
...
canada.data$answer <- as.numeric(canada.data$answer)
...
#save and export
write.csv(all.data, here::here("C:/Users/Bubulubu/Documents/haleh_project_2024/data/cleaned_data/study1_mc_all_data.csv"))

# Study 2 ----
#read in data 
iran.study.2 <- read.csv(here::here("C:/Users/Bubulubu/Documents/haleh_project_2024/data/raw_data/study2/iran_study2_data.csv"))
...
#save and export
write.csv(iran.study.2, here::here("C:/Users/Bubulubu/Documents/haleh_project_2024/data/cleaned_data/study2_mc_iran.csv"))
...
write.csv(s1_distinct, here::here("C:/Users/Bubulubu/Documents/haleh_project_2024/data/sanity_check/distinct_subs.csv"))
